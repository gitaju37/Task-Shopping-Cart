...
const App = () => {
  ...
  return (
    <>
      ...
      <MyContext.Provider value={{ Products, cart, setCart, cartProducts, setCartProducts, total, setTotal, increaseQuantity, decreaseQuantity, deleteFromCart, calculateTotal }} >
